            ...
            <div class="page-header__content" data-aos="fade-right" data-aos-duration="1000">
                ...
                <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb" class="d-none">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">USD/CHF</li>
                    </ol>
                </nav>
            </div>
                    ...
                    <div class="service-details__item">
                        <div class="service-details__item-inner ">
                            ...
                            <div class="service-details__content" data-aos="fade-up" data-aos-duration="900">
                                ...
                                <h3 class="mb-15"> <a class="stretched-link" href="javascript:void(0);">USD/CHF Chart</a></h3>
                                <p class="mb-5">View indicative pricing and leverage information for USD/CHF</p>
