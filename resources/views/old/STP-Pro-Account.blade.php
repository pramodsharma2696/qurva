    ...
    <div class="container">
        <div class="service-details__wrapper">
                            ...
                            <div class="service-details__content" data-aos="fade-up" data-aos-duration="900">
                                <section class="faq padding-top padding-bottom of-hidden">
                                    <div class="section-header">
                                        <h2 class="mb-10 mt-minus-5"><span>STP Pro</span> Account</h2>
                                        <p>The STP Pro Account at Qorva Markets is tailored for traders seeking enhanced trading conditions and direct market access.
                                     With tight spreads from 0 pips, lightning-fast execution, and no dealing desk intervention, this account caters to professional traders
                                      who demand precision and transparency in their trading experience</p>
                                    </div>
            ...
            <div class="row mb-15 g-5">
                <h3 class="mb-15">
                    <a class="stretched-link" href="javascript:void(0);">STP Pro Account Info</a>
                </h3>
            </div>
            <div class="row">
