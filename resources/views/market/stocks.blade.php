    ...
    <div class="container">
        ...
        <div class="row pt-5 pb-5">
            <div class="col-md-6">
                <div class="align-middle d-table-cell">
                    ...
                    <p>- US Stocks: Apple, Tesla, Amazon, and more.</p>
                    <p>- European Equities: Nestlé, Volkswagen, and LVMH.</p>
                    <p>- Asian Markets: Alibaba, Toyota, and Samsung.</p>

                    <h4>Simplified Trading Tools </h4>
                    <p>Our platform is designed to meet the needs of all traders:
                    </p>
                    <p>- Real-time stock market analysis for faster decisions.
                    </p>
                    <p>- Customisable stock trading strategies tailored to your goals.
                    </p>
                    <p>- Advanced charts and indicators for tracking stock trends.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p>Enjoy low spreads, transparent fees, and cost-effective trading, ensuring more of your investment works for you.
                    </p>
        ...
        <div class="row pt-5 pb-5">
            <div class="col-md-6">
                <div class="align-middle d-table-cell">
                    ...
                    <h4>Customisable Trading Dashboards</h4>
                    <p>Stay in control with intuitive dashboards that allow you to manage and monitor your stock portfolio effortlessly. </p>


                    <h4>Market Insights and Analytics
                    </h4>
                    <p>Stay updated with expert-driven insights, including:
                    </p>
                    <p>- Stock trading tips and strategies.

                    </p>
                    <p>- Regular updates on market-moving events.
                    </p>
            ...
            <div class="row pt-5 pb-5">
                ...
                <div class="col-md-6">
                    ...
                    <p>Whether you're a beginner or an advanced trader, our resources help you master:
                    </p>
                    <p>- How to trade stocks effectively.
                    </p>
                    <p>- Strategies for reducing risks in volatile markets.
                    </p>
                    <p>- Long-term vs. short-term trading approaches.
                    </p>
                </div>
            ...
            <div class="row pt-5 ">
                <div class="col-md-12">
                    <h4>Leverage and Margin Options
                    </h4>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h5 class="lg_font">The Qorva Advantage in Stock Trading
                </h5>
                <h4>Innovative Technology
                </h4>
                <p>Qorva Markets integrates cutting-edge technology to offer:
                </p>
                <p>- Real-time market data.
                </p>
                <p>- Automated trading solutions for better efficiency.
                </p>
                <p>- Tools for identifying high-performing stocks.
                </p>

                <h4>For Every Type of Investor
                </h4>
                <p>- New Investors: Learn the basics with beginner-friendly features and guides.
                </p>
                <p>- Experienced Traders: Access advanced analytics and high-speed execution for superior trading.
                </p>
                <p>- Passive Investors: Build a portfolio with long-term growth potential.
                </p>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h5 class="lg_font">Start Your Stock Trading Journey Today
                </h5>
