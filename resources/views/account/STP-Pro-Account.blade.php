            ...
            <div class="row">
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="banner-content text-center">
                        <h1>STP Pro Account</h1>
                        <p><a href="#">Home</a> <span> &gt; </span>STP Pro Account</p>
                    </div>
                </div>
                <!--end heading-->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="about-img1">
                        <img src="{{ asset('') }}uploads/new/accounts/3.png" class="img_res" alt="image">
